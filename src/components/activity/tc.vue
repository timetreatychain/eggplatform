	...
	<div class="choice_pic" ref="wrapper">
		<div class="choice_pic_inner content">
			...
			<ul class="down_pto">
				...
				<li @click="selectpic(3)" :class="{'cur' : cur == 3}">
					<span class="choice"></span>
					<div class="bg">
						<i id="qrcode4" ref="qrcode4"></i>
					</div>
					<!-- <div class="info">
                        <div class="info_l">
                            <p>立即注册即送20BIDT</p>
					...
					$.ajax({
						...
						success: function(data) {
							if(data.state.code == 20000) {
								...
								// console.log(vm.link3)
								vm._getQart("qrcode1", vm.link3);
								vm._getQart("qrcode2", vm.link3);
								vm._getQart("qrcode3", vm.link3);
								vm._getQart("qrcode4", vm.link3);
								// vm._getQart("qrcode4", vm.link3);
							}
						}
					});
