...
(function($) {
	...
	function handleScroll(wrapper, iframe) {
		...
		var scrollTop = (parseFloat(sessionStorage.egg_getItem(key)) || 0);
		if(scrollTop) {
			(function(y) {
		...
		setInterval(function() {
			...
			if(scrollTop !== _scrollTop) {
				sessionStorage.egg_setItem(key, _scrollTop + '');
...
(function($, window) {
	...
	var Slider = $.Slider = $.Scroll.extend({
		...
		nextItem: function() {
			this.slideNumber++;
			this._gotoItem(this.slideNumber, this.options.scrollTime);
		},
		prevItem: function() {
			this.slideNumber--;
			this._gotoItem(this.slideNumber, this.options.scrollTime);
